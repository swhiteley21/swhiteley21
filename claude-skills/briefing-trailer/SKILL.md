...
- `scripts/render_text.py` — bundled asset/template; copy and adapt, do not edit in place.
- `scripts/build_trailer.py` — bundled asset/template; copy and adapt, do not edit in place.
