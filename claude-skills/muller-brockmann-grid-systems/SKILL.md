...
- `scripts/grid_tokens.py` — bundled asset/template; copy and adapt, do not edit in place.
- `scripts/verify_grid.js` — bundled asset/template; copy and adapt, do not edit in place.
